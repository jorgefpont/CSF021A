...
class Controller:
    ...
    the appropriate methods in the Model. The Controller handles all
    ...
    def __init__(self):
        ...
        instantiates the View (a MyFrame object), and starts the event loop
        that waits for the user to press a Button on the View.
        """
