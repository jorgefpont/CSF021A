...
""" 
sets up a gui that accepts the user's name and 
greets them when a button is pressed
"""
...
class MyFrame(tkinter.Frame):
    ...
    def sayHi(self):
        """ greets the user by taking the text from
        the nameEntry field and putting it
        into the greeting field """
